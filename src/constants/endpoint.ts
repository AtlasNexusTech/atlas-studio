export const isTest =
  window.location.origin === 'https://atlasnexus.tech' && window.location.pathname.includes('/atlas-studio-test');

export const BASE_URL_PROXY = 'https://nexior-auth-proxy.onrender.com';
export const BASE_URL_PLATFORM = BASE_URL_PROXY;
export const BASE_URL_HUB = BASE_URL_PROXY;
export const BASE_URL_AUTH = BASE_URL_PROXY;
export const BASE_URL_API = BASE_URL_PROXY;
